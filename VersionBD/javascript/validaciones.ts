...
function AdministrarValidaciones(): void 
{
    ...
    if(VerificarValidacionesIndex())
    {
        ...
        xhr.open('POST', "http://localhost/prog_lab_3/prog_3/TP1/PrteFinalBD/backend/administracion.php", true);
        xhr.send(form);
...
function AdministrarValidacionesLogin():void
{
    ...
    if(VerificarValidacionesLogin())
    {
        ...
        ajax.Post("http://localhost/prog_lab_3/prog_3/TP1/PrteFinalBD/backend/verificarUsuario.php",
            LoginSuccess,
            params,
            Fail);
    }
...
function AdministrarEliminar(legajo:number)
{
    ...
    ajax.Post("http://localhost/prog_lab_3/prog_3/TP1/PrteFinalBD/backend/eliminar.php",
                DeleteSuccess,
                parametro,
                Fail)
}
...
function MostrarLista():void {
    ...
    ajax.Post("http://localhost/prog_lab_3/prog_3/TP1/PrteFinalBD/backend/mostrar.php", 
                MostrarListaSuccess, 
                parametros, 
                Fail);            
}
...
function LoginSuccess(retorno:string){
    ...
    window.location.href = "http://localhost/prog_lab_3/prog_3/TP1/PrteFinalBD/index.php";
}
